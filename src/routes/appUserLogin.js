...
const { create, del, getById, get, update, validate } = require("../models-mssql/AppUserLogin");

router.get("/", async (req, res, next) => {
  console.log("/AppUserLogin GET call", req.query.tenantId);
  try {
...
router.get("/:id", async (req, res, next) => {
  console.log("/AppUserLogin GET call");
  try {
    if (req.query.tenantId && req.query.appId) {
...
router.post("/", async (req, res, next) => {
  console.log("/AppUserLogin POST call");
  // prepare body
  // let body;
...
router.put("/:id", async (req, res, next) => {
  console.log("/AppUserLogin PUT call", req.params.id);
  // prepare body
...
router.delete(
  "/:id",
  async (req, res, next) => {
    console.log("/AppUserLogin DELETE call", req.params.id);
    if (req.query.tenantId && req.query.appId) {
