...
const { get, validate, create, update, del } = require("../models-mssql/ApplicationAYClassSection");

router.get("/", async (req, res, next) => {
  console.log("/ApplicationAYClassSection GET call");
  try {
...
router.post("/", async (req, res, next) => {
  console.log("/ApplicationAYClassSection POST call");
...
router.delete("/:id", async (req, res, next) => {
  console.log("/ApplicationAYClassSection DELETE call", req.params.id);
  const data = await del(req.params.id);
  next(new QueryResult(data));
}, returnStateHandler);

router.put("/:id", async (req, res, next) => {
  console.log("/ApplicationAYClassSection PUT call", req.params.id);
