...
const { get, validate, create, update, del } = require("../models-mssql/ApplicationAYClassSectionsSubjectExamMarks");
...
router.post("/", async (req, res, next) => {
  console.log("/ApplicationAYClassSectionsSubjectExamMarks POST call");
...
router.delete("/:id", async (req, res, next) => {
  console.log("/ApplicationAYClassSectionsSubjectExamMarks DELETE call", req.params.id);
  const data = await del(req.params.id);
  next(new QueryResult(data));
}, returnStateHandler);

router.put("/:id", async (req, res, next) => {
  console.log("/ApplicationAYClassSectionsSubjectExamMarks PUT call", req.params.id);
