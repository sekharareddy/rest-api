...
const { create, del, getById, get, update, validate } = require("../models-mssql/ApplicationAgreementDay");

router.get("/", async (req, res, next) => {
  console.log("/ApplicationAgreementDay GET call");
  try {
...
router.post("/", async (req, res, next) => {
  console.log("/ApplicationAgreementDay POST call");
  // prepare body
  // let body;
...
router.put("/:id", async (req, res, next) => {
  console.log("/ApplicationAgreementDay PUT call", req.params.id);
  // prepare body
...
router.delete(
  "/:id",
  async (req, res, next) => {
    console.log("/ApplicationAgreementDay DELETE call", req.params.id);
