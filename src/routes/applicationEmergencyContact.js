...
const { create, del, getById, get, update, validate } = require("../models-mssql/ApplicationEmergencyContact");

router.get("/", async (req, res, next) => {
  console.log("/ApplicationEmergencyContact GET call");
  try {
...
router.post("/", async (req, res, next) => {
  console.log("/ApplicationEmergencyContact POST call");
  // prepare body
  // let body;
...
router.put("/:id", async (req, res, next) => {
  console.log("/ApplicationEmergencyContact PUT call", req.params.id);
  // prepare body
...
router.delete(
  "/:id",
  async (req, res, next) => {
    console.log("/ApplicationEmergencyContact DELETE call", req.params.id);
