...
const { create, del, getById, get, update, validate } = require("../models-mssql/ApplicationPickupPermission");

router.get("/", async (req, res, next) => {
  console.log("/ApplicationPickupPermission GET call");
  try {
...
router.post("/", async (req, res, next) => {
  console.log("/ApplicationPickupPermission POST call");
  // prepare body
  // let body;
...
router.put("/:id", async (req, res, next) => {
  console.log("/ApplicationPickupPermission PUT call", req.params.id);
  // prepare body
...
router.delete(
  "/:id",
  async (req, res, next) => {
    console.log("/ApplicationPickupPermission DELETE call", req.params.id);
    if (req.params.id == "undefined") {
      console.log("Invalid applicationPickupPermissionId");
      next({ error: new Error("Invalid applicationPickupPermissionId"), status: HttpStatus.BAD_REQUEST });
    } else {
