...
const { get, validate, create, update, del } = require("../models-mssql/ApplicationScholarship");

router.get("/", async (req, res, next) => {
  console.log("/ApplicatioScholarships GET call");
  try {
...
router.post("/", async (req, res, next) => {
  console.log("/ApplicatioScholarships POST call");
...
router.delete("/:id", async (req, res, next) => {
  console.log("/ApplicatioScholarships DELETE call", req.params.id);
  const data = await del(req.params.id);
  next(new QueryResult(data));
}, returnStateHandler);

router.put("/:id", async (req, res, next) => {
  console.log("/ApplicatioScholarships PUT call", req.params.id);
