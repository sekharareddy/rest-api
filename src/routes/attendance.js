...
const { create, update, get, getById, validate } = require("../models-mssql/Attendance");

router.get("/", async (req, res, next) => {
  console.log("/attendance GET call");
  try {
    let data;
...
router.get("/:id", async (req, res, next) => {
  console.log("/attendance GET/:id call");
  try {
...
router.post("/", async (req, res, next) => {
  console.log("/attendance POST call");
...
router.put("/:id", async (req, res, next) => {
  console.log("/attendance/:id PUT call", req.params.id);
...
router.put("/", async (req, res, next) => {
  console.log("/attendance PUT call");
