...
const { get, validate, create, update, del } = require("../models-mssql/ClassSections");

router.get("/", async (req, res, next) => {
  console.log("/ClassSections GET call");
  try {
...
router.post("/", async (req, res, next) => {
  console.log("/ClassSections POST call");
...
router.delete("/:id", async (req, res, next) => {
  console.log("/ClassSections DELETE call", req.params.id);
  const data = await del(req.params.id);
  next(new QueryResult(data));
}, returnStateHandler);

router.put("/:id", async (req, res, next) => {
  console.log("/ClassSections PUT call", req.params.id);
