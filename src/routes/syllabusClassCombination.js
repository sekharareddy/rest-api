...
const { get, validate, create, update, del } = require("../models-mssql/SyllabusCLassCombination");

router.get("/", async (req, res, next) => {
  console.log("/syllabusCLassCombination GET call");
  try {
...
router.post("/", async (req, res, next) => {
  console.log("/syllabusCLassCombination POST call");
...
router.delete("/:id", async (req, res, next) => {
  console.log("/syllabusCLassCombination DELETE call", req.params.id);
  const data = await del(req.params.id);
  next(new QueryResult(data));
}, returnStateHandler);

router.put("/:id", async (req, res, next) => {
  console.log("/syllabusCLassCombination PUT call", req.params.id);
