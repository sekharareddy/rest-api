...
const { get, validate, create, update, del } = require("../models-mssql/TeachingMedium");

router.get("/", async (req, res, next) => {
  console.log("/TeachingMedium GET call");
  try {
...
router.post("/", async (req, res, next) => {
  console.log("/TeachingMedium POST call");
...
router.delete("/:id", async (req, res, next) => {
  console.log("/TeachingMedium DELETE call", req.params.id);
  const data = await del(req.params.id);
  next(new QueryResult(data));
}, returnStateHandler);

router.put("/:id", async (req, res, next) => {
  console.log("/TeachingMedium PUT call", req.params.id);
